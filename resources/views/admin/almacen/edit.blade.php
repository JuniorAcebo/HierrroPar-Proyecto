            ...
            <form action="{{ route('almacenes.update', $almacen) }}" method="post">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="codigo" id="codigo" value="{{ old('codigo', $almacen->codigo) }}" 
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $almacen->nombre) }}" 
                            class="form-control @error('nombre') is-invalid @enderror" placeholder="Nombre del almacén">
                        @error('nombre')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="direccion" id="direccion" value="{{ old('direccion', $almacen->direccion) }}" 
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="descripcion" id="descripcion" rows="3" 
                            class="form-control @error('descripcion') is-invalid @enderror" placeholder="Opcional...">{{ old('descripcion', $almacen->descripcion) }}</textarea>
                        @error('descripcion')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mt-4 text-center">
                    <button type="submit" class="btn btn-primary d-inline-flex align-items-center gap-2">
                        <i class="fas fa-sync"></i> Actualizar Almacén
                    </button>
