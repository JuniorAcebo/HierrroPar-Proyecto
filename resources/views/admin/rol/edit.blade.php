        ...
        <div class="card-clean">
            ...
            <div class="card-header-clean" style="margin-bottom: 15px;">
                <div class="card-header-title">
                    <i class="fas fa-user-shield"></i> Editar Rol
                </div>
            </div>
                ...
                <form action="{{ route('roles.update',['role' => $role->id]) }}" method="post" novalidate>
                    ...
                    <div class="mb-4">
                        ...
                        <input autocomplete="off" type="text" name="name" id="name"
                            value="{{ old('name', $role->name) }} " aria-labelledby="nameHelpBlock">
                    ...
                    <div class="mb-4">
                        ...
                        @php
                            ...
                            $selectedPermisos = old('permisos', $rolePermisoIds ?? []);
                            // cuando se envía el hidden field sin chequear nada, old devuelve cadena vacía
                            if (!is_array($selectedPermisos)) {
                                $selectedPermisos = [];
                            }
                        @endphp

                        {{-- siempre envía el campo aunque no haya permisos seleccionados --}}
                                        ...
                                        @foreach ($listaPermisos as $permiso)
                                            <div class="form-check">
                                                ...
                                                <input class="form-check-input perm-checkbox" type="checkbox" name="permisos[]"
                                                    ...
                                                    {{ in_array($permiso->id, $selectedPermisos) ? 'checked' : '' }}>
