                ...
                <div class="row g-3 align-items-center">
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <input type="text" name="busqueda" class="form-control form-control-clean border-start-0 ps-0" placeholder="Buscar producto..." value="{{ $busqueda ?? '' }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                ...
                <table id="datatablesSimple" class="custom-table">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <button class="sort-btn {{ $sort == 'precio_venta' ? 'active ' . $direction : '' }}" data-column="precio_venta">
                                    Precios <i class="fas fa-sort sort-icon"></i>
                                </button>
                            </th>
                            <th class="text-center">
                                <button class="sort-btn {{ $sort == 'stock_total' ? 'active ' . $direction : '' }}" data-column="stock_total">
                                    Stock Total <i class="fas fa-sort sort-icon"></i>
                                </button>
                            </th>
                            <th>
                                <button class="sort-btn {{ $sort == 'categoria' ? 'active ' . $direction : '' }}" data-column="categoria">
                        ...
                        <tr data-product-id="{{ $item->id }}">
                            ...
                            <td>
                                <div class="btn-action-group">
                                    @can('ver-producto')
                                    <button class="btn-icon-soft" data-bs-toggle="modal" data-bs-target="#verModal-{{ $item->id }}" title="Ver Detalles">
                                ...
                                <div class="modal-content modal-content-clean">
                                    ...
                                    <div class="modal-body p-4">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-3">
                                                <label class="info-subtext mb-1">Stock Mínimo</label>
                                            ...
                                            <div class="col-md-3">
                                                <label class="info-subtext mb-1">Stock Máximo</label>
                                                <div class="fw-bold text-warning">
                                                    {{ $item->stock_maximo > 0 ? $item->stock_maximo : 'Sin límite' }}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="row mt-2">
                                                @forelse($item->inventarioAlmacenes as $inv)
                                                <div class="col-md-6 mb-2">
                                                    <div class="d-flex justify-content-between align-items-center p-2 border rounded-3 bg-white">
                                                        ...
                                                        if ($inv->stock < $item->stock_minimo) {
                                                            $badge = 'bg-danger-subtle text-danger';
                                                            } elseif ($item->stock_maximo > 0 && $inv->stock > $item->stock_maximo) {
                                                            $badge = 'bg-warning-subtle text-warning';
                                                            }
                                                            @endphp

                                                            <span class="badge {{ $badge }} px-3">
                                                                {{ $inv->stock }}
                                                            </span>
                                                    </div>
                                                </div>
                                ...
                                <div class="modal-content modal-content-clean">
                                    ...
                                    <div class="modal-body p-4 text-center">
                                        ...
                                        <p class="text-muted small mb-4">
                                            @if($item->estado == 1)
                                            Puede <strong>desactivar</strong> el producto para que no aparezca en ventas.
                                            @else
                                        ...
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <form action="{{ route('productos.updateEstado', $item) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('PATCH')
                                                <input type="hidden" name="accion" value="{{ $item->estado == 1 ? 'inactivar' : 'activar' }}">
                                                <button type="submit" class="btn {{ $item->estado == 1 ? 'btn-outline-warning' : 'btn-outline-success' }} btn-sm px-3">
                        ...
                        <tr class="table-totals">
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-4">
                                    <div>
                                        <span class="totals-value text-danger">{{ $bajoStockCount }}</span>
                                        <span class="totals-subtext d-block">Bajo</span>
                                    </div>

                                    <div>
                                        <span class="totals-value text-warning">{{ $excesoStockCount }}</span>
                                        <span class="totals-subtext d-block">Exceso</span>
                                    </div>
                                </div>
                            </td>
                        </tr>
